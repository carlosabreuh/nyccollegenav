...
export function determineApplication(answers: QuestionnaireAnswers): ApplicationRecommendation {
  ...
  if (answers.citizenship === 'undocumented' && answers.nyHighSchool) {
    return {
      ...
      additionalPrograms: [
        { name: 'NYS TAP Grant', url: 'https://www.hesc.ny.gov/pay-for-college/financial-aid/types-of-financial-aid/nys-grants-scholarships-awards/tap.html' },
        { name: 'Excelsior Scholarship', url: 'https://www.hesc.ny.gov/pay-for-college/financial-aid/types-of-financial-aid/nys-grants-scholarships-awards/the-excelsior-scholarship.html' }
      ]
    };
  }
  ...
  if (answers.citizenship === 'citizen' || answers.citizenship === 'permanent_resident') {
    ...
    return {
      ...
      additionalPrograms: [
        ...
        { name: 'Federal Work-Study', url: 'https://studentaid.gov/understand-aid/types/work-study' },
        { name: 'CSS Profile (for private colleges)', url: '/css-profile' }
      ]
    };
  }
  ...
  if (answers.citizenship === 'daca') {
    return {
      ...
      additionalPrograms: [
        { name: 'NYS TAP Grant', url: 'https://www.hesc.ny.gov/pay-for-college/financial-aid/types-of-financial-aid/nys-grants-scholarships-awards/tap.html' },
        { name: 'TheDream.US Scholarships', url: 'https://www.thedream.us/' }
      ]
    };
  }
